...
export class Migration20230501052857 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "messages" ("message_id" serial primary key, "sender_id" int not null, "receiver_id" int not null, "created_at" timestamptz(0) not null, "message" varchar(255) not null);');
